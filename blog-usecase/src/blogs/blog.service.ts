...
export class blogService {
       ...
       constructor (
              ...
              @InjectRepository(BlogAccess) private blogAccessRepository: Repository<BlogAccess>
       ...
       async createBlog(createBLogDto : CreateBlogDto,authenticatedPerson) {
              ...
              try {
                     ...
                     const authorizationData = await this.topicAccessRepository.find({where: {topic_:{id:topic_id}},
                     ...
                     if(authorizedPerson !== authenticatedPerson){
                            throw new CustomError(404 , "You are not allowed to create or edit a blog of this topic ");
                     }
                     ...
                     const createBlogAccessData=this.blogAccessRepository.create({topic_:topic_id, user_:authorizedPerson, blog_: id})
